...
class UpdateDashboard(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget('dashboard.html')
        #return MockTarget('update', mirror_on_stderr=True)
...
class UpdateWebSite(luigi.Task):
    ...
    def requires(self):
        return [WebSitePull(), UpdateDashboard()]

    def output(self):
        return luigi.LocalTarget(WEB_DIR + '/_includes/COVID.html')
